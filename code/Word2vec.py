...
class W2v:
    def __init__(self):
        ...
        self.project='eclipse'
        self.dup='' #_without_dup
        self.file_path=self.server+'valid-bug-report/dataset/'+self.project+'/preprocess/'
        self.save_path=self.server+'valid-bug-report/model/word2vec/'+self.project+self.dup+'/'
    ...
    def train(self,sentences):
        ...
        model = word2vec.Word2Vec(sentences, size=200, window=5, min_count=5, workers=4, sg=1)
